...
## }
  ...
  HALIGN_STYLES <- c(2,6,4,0,5,1,3)
  names(HALIGN_STYLES) <- c('ALIGN_CENTER' ,'ALIGN_CENTER_SELECTION'
    ,'ALIGN_FILL' ,'ALIGN_GENERAL' ,'ALIGN_JUSTIFY' ,'ALIGN_LEFT'
    ,'ALIGN_RIGHT')

  VALIGN_STYLES <- c(2,1,3,0)
  names(VALIGN_STYLES) <- c('VERTICAL_BOTTOM' ,'VERTICAL_CENTER',
                             'VERTICAL_JUSTIFY' ,'VERTICAL_TOP')
              
  BORDER_STYLES <- c(9,11,3,7,6,4,2,10,12,8,0,13,5,1)
  names(BORDER_STYLES) <- c("BORDER_DASH_DOT", "BORDER_DASH_DOT_DOT",
  ...
  FILL_STYLES <- c(3,9,10,16,2,18,17,0,1,4,15,7,8,5,6,13,14,11,12)
  names(FILL_STYLES) <- c('ALT_BARS', 'BIG_SPOTS','BRICKS' ,'DIAMONDS'
  ...
  CELL_STYLES <- c(HALIGN_STYLES, VALIGN_STYLES, BORDER_STYLES,
                    FILL_STYLES)
