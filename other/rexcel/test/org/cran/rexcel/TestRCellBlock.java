...
public class TestRCellBlock {
    ...
    public Path folder;
    TestRCellBlock() throws IOException {
      folder  = Files.createTempDirectory("/tmp");
    }
  ...
  public void writeXLSX() throws IOException{
    ...
    // create a new file
    FileOutputStream out = new FileOutputStream( new File(folder.toAbsolutePath() + "junk.xlsx"));
